...
// --------- class _c2py_cls_6 -----------
using _c2py_cls_6                                            = triqs::modest::one_body_elements_on_grid;
template <> constexpr bool c2py::is_wrapped<_c2py_cls_6>     = true;
template <> inline constexpr auto c2py::tp_name<_c2py_cls_6> = "triqs_modest.obe.OneBodyElementsOnGrid";
...
template <> constexpr initproc c2py::tp_init<_c2py_cls_6> = synth_constructor_5;
...
constexpr auto _c2py_doc_member_16 = R"DOC(Band dispersion.)DOC";
constexpr auto _c2py_doc_member_17 = R"DOC(Local :math:`\mathcal{C}` space.)DOC";
constexpr auto _c2py_doc_member_18 = R"DOC(Downfolding projector :math:`P`.)DOC";
constexpr auto _c2py_doc_member_19 = R"DOC(IBZ symmetrizer after a k-sum)DOC";
...
constinit PyGetSetDef c2py::tp_getset<_c2py_cls_6>[] = {
   c2py::getsetdef_from_member<&_c2py_cls_6::H, _c2py_cls_6>("H", _c2py_doc_member_16),
   c2py::getsetdef_from_member<&_c2py_cls_6::C_space, _c2py_cls_6>("C_space", _c2py_doc_member_17),
   c2py::getsetdef_from_member<&_c2py_cls_6::P, _c2py_cls_6>("P", _c2py_doc_member_18),
   c2py::getsetdef_from_member<&_c2py_cls_6::ibz_symm_ops, _c2py_cls_6>("ibz_symm_ops", _c2py_doc_member_19),
   {"__dict__", (getter)prop_get_dict_5, nullptr, "", nullptr},
   {nullptr, nullptr, nullptr, nullptr, nullptr}};

template <>
const std::string c2py::tp_doc<_c2py_cls_6> = R"DOC(A one-body elements struct where all of the underlying data exists on a fixed momentum grid.)DOC"
...
static PyMethodDef module_methods[] = {
   ...
   {"one_body_elements_on_high_symmetry_path", (PyCFunction)c2py::pyfkw<_c2py_fun_7>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_7.c_str()},
   {"one_body_elements_with_theta_projectors", (PyCFunction)c2py::pyfkw<_c2py_fun_8>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_8.c_str()},
   {nullptr, nullptr, 0, nullptr} // Sentinel
};
...
#define _add_type(T, N) c2py::add_type_object_to_main<T>(N, m, conv_table)
  ...
  _add_type(_c2py_cls_6, "OneBodyElementsOnGrid");
#undef _add_type
