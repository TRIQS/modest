...
static auto const _c2py_fun_3 = c2py::dispatcher_f_kw_t{
   c2py::cmethod([](_c2py_cls_0 const &self,
                    const std::vector<triqs::block_matrix_t> &Sigma_imp_static_vec) -> decltype(auto) { return self.embed_ij(Sigma_imp_static_vec); },
                 "self", "Sigma_imp_static_vec")};
...
static auto const _c2py_fun_4 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 const &self,
      const std::vector<nda::basic_array<std::complex<double>, 4, nda::C_layout, 'A',
                                         nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>>> &U_tensor_vec) -> decltype(auto) {
     return self.embed_ijkl(U_tensor_vec);
   },
   "self", "U_tensor_vec")};
...
static auto const _c2py_fun_5 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 const &self,
      const std::vector<std::vector<
         ...
         &Sigma_imp_vec) -> decltype(auto) { return self.embed_wij(Sigma_imp_vec); },
   "self", "Sigma_imp_vec")};
...
static auto const _c2py_fun_6 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 const &self,
      const std::vector<nda::basic_array<std::complex<double>, 5, nda::C_layout, 'A',
                                         nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>>> &pi_imp_vec) -> decltype(auto) {
     return self.embed_wijkl(pi_imp_vec);
   },
   "self", "pi_imp_vec")};
...
static auto const _c2py_fun_8 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 const &self,
      const nda::basic_array<std::complex<double>, 4, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>>
         &U_tensor) -> decltype(auto) { return self.extract_ijkl(U_tensor); },
   "self", "U_tensor")};

// extract_wij
static auto const _c2py_fun_9 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 const &self,
      const nda::basic_array<std::complex<double>, 4, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> &g_loc)
      -> decltype(auto) { return self.extract_wij(g_loc); },
   "self", "g_loc")};

// extract_wijkl
static auto const _c2py_fun_10 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 const &self,
      const nda::basic_array<std::complex<double>, 5, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>>
         &Pi_loc) -> decltype(auto) { return self.extract_wijkl(Pi_loc); },
   "self", "Pi_loc")};
...
PyMethodDef c2py::tp_methods<_c2py_cls_0>[] = {
   ...
   {"embed_ij", (PyCFunction)c2py::pyfkw<_c2py_fun_3>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_3.c_str()},
   {"embed_ijkl", (PyCFunction)c2py::pyfkw<_c2py_fun_4>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_4.c_str()},
   {"embed_wij", (PyCFunction)c2py::pyfkw<_c2py_fun_5>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_5.c_str()},
   {"embed_wijkl", (PyCFunction)c2py::pyfkw<_c2py_fun_6>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_6.c_str()},
   {"extract", (PyCFunction)c2py::pyfkw<_c2py_fun_7>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_7.c_str()},
   {"extract_ijkl", (PyCFunction)c2py::pyfkw<_c2py_fun_8>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_8.c_str()},
   {"extract_wij", (PyCFunction)c2py::pyfkw<_c2py_fun_9>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_9.c_str()},
   {"extract_wijkl", (PyCFunction)c2py::pyfkw<_c2py_fun_10>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_10.c_str()},
   {"flip_spin", (PyCFunction)c2py::pyfkw<_c2py_fun_11>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_11.c_str()},
   {"imp_decomposition", (PyCFunction)c2py::pyfkw<_c2py_fun_12>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_12.c_str()},
   {"make_zero_imp_self_energies", (PyCFunction)c2py::pyfkw<_c2py_fun_13>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_13.c_str()},
   {"n_gamma", (PyCFunction)c2py::pyfkw<_c2py_fun_14>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_14.c_str()},
   {"replace", (PyCFunction)c2py::pyfkw<_c2py_fun_15>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_15.c_str()},
   {"split", (PyCFunction)c2py::pyfkw<_c2py_fun_16>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_16.c_str()},
...
static PyMethodDef module_methods[] = {
   {"embedding_builder", (PyCFunction)c2py::pyfkw<_c2py_fun_17>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_17.c_str()},
   {"make_embedding", (PyCFunction)c2py::pyfkw<_c2py_fun_18>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_18.c_str()},
   {"make_embedding_with_clusters", (PyCFunction)c2py::pyfkw<_c2py_fun_19>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_19.c_str()},
   {nullptr, nullptr, 0, nullptr} // Sentinel
};
